-- Re-establish the v0.9 lifecycle CHECK as one atomic PostgreSQL unit.
-- Existing migrations remain immutable; this migration is additive.
BEGIN;

ALTER TABLE "recommendation_runs"
  DROP CONSTRAINT IF EXISTS "recommendation_runs_lifecycle_shape_check";
