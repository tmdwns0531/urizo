...
export function LandingFooter() {
  return (
    <footer id="service-principles" className="cinema-footer scroll-mt-20 bg-[#090d12] px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl py-16 sm:py-20">
        <div className="flex flex-col gap-9 border-b border-white/10 pb-12 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            <p className="text-xs font-bold tracking-[0.18em] text-[#ff8d6b]">오늘의 선택을 더 가볍게</p>
        ...
        <div className="grid gap-10 py-10 sm:grid-cols-[1fr_auto] sm:items-start">
          <div>
            ...
            <p className="mt-4 max-w-md text-sm leading-6 text-slate-500">
              오늘 볼 작품을 고르는 데 필요한 조건과 이유를 한곳에서
              확인하는 익명 추천 서비스입니다.
            </p>
          </div>
          <ul className="grid gap-2 text-sm text-slate-500 sm:text-right" aria-label="서비스 원칙">
            <li>계정 없이 바로 사용</li>
            <li>조건 변경 전 사용자 확인</li>
            <li>추천 이유와 확인 과정 공개</li>
          </ul>
        </div>
        <div className="flex flex-col gap-2 border-t border-white/10 pt-6 text-xs text-slate-600 sm:flex-row sm:items-center sm:justify-between">
          <p>© 2026 OTT 다모아</p>
