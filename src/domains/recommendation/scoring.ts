...
const qualityRaw = (result: SearchResult): number =>
 ...
 * All other component scores are ratios or cosine scores already bounded to
 * [0, 1], and every component is clamped before weighting.
 */
function normalizeQuality(results: readonly SearchResult[]): Map<string, number> {
